...
\newcommand\thesistitle{Title of your dissertation} % Dissertation Title
\newcommand\authorname{First (Middle) Last name} % Full Name
\newcommand\authordegrees{BSc (Hons)} % This does not have to be filled in, but it is advised you include any degrees you have.
